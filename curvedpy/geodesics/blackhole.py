...
class BlackholeGeodesicIntegrator:
    ...
    #
    ################################################################################################
    def __init__(self, mass=1.0, a = 0, time_like = False, theta_switch = 0.1*np.pi, verbose=False):#coordinates = "lpn", 
        """
        ...
        if a == 0:
            ...
            # if coordinates == "xyz": # ONLY FOR TESTING
